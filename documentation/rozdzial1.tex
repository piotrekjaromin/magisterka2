...
\begin{itemize}
\item Pierwszy z nich zawiera wstęp, cele pracy, wykorzystanye technologie oraz przegląd literatury.
\item W drugim rozdziale zawarto opracowanie teoretyczne poszczególnych części algorytmu. Przedstawiono również ogólny schemat, sposób w jaki algorytm pobiera dane, skąd je bierze i jak je parsuje, przetwarza i wyświetla na stronie.
\item Trzeci rozdział opisuje poszczególne obiekty, wykorzystywane przez algorytm wraz z ich wizualizacją.
\item W czwartym rozdziale został przedstawiony interfejs użytkownika
\item Piąty zawiera wnioski z celów postawionych w niniejszej pracy.
\end{itemize}
